/**
 * Компонент "Выбор даты и времени".
 ...
 * @version   $Id: 1.0 $
 *
 * @license DateTimePicker.js is licensed under the terms of the Open Source
...
/**
 * @class Ge.view.picker.DateTimePicker
 * @extends Ext.picker.Date
 * Выбор даты и времени.
 */
Ext.define('Ge.view.picker.DateTimePicker', {
