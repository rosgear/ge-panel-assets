/**
 * @class Ge.view.portal.DropZone
 * @extends Ext.dd.DropTarget
 * Internal class that manages drag/drop for {@link Ge.view.portal.Portal}.
 */
Ext.define('Ge.view.portal.DropZone', {
    extend: 'Ext.dd.DropTarget',

    constructor: function(portal, cfg) {
        this.portal = portal;
        Ext.dd.ScrollManager.register(portal.body);
        Ge.view.portal.DropZone.superclass.constructor.call(this, portal.body, cfg);
    ...
    unreg: function() {
        ...
        Ge.view.portal.DropZone.superclass.unreg.call(this);
