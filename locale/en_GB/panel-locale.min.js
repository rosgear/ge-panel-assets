...
Ext.Txt = { message: 'Message', confirmation: 'Confirmation', warning: 'Warning', error: 'Error', errorConnect: 'Connection error', loading: 'Loading...', waiting: 'Please wait...', sendErrorReport: '<div class="g-message-box__report">Send error to technical support?</div>', serverDidNotAnswer: 'Our your request, the server did not answer.', serverErrorConnection: 'A server connection error may occur due to an unstable network connection or a server failure. Please try again later.' };
Ext.define("Ext.locale.ru.grid.locking.Lockable", { override: "Ext.grid.locking.Lockable", lockText: "Block column", unlockText: "Unblock column (unlock)" });
Ext.define("Ext.locale.ru.grid.filters.Filters", { override: "Ext.grid.filters.Filters", menuFilterText: "Filter" });
Ext.define("Ext.locale.ru.grid.filters.filter.Boolean", { override: "Ext.grid.filters.filter.Boolean", yesText: "Yes", noText: "No" });
Ext.define("Ext.locale.ru.grid.filters.filter.Date", { override: "Ext.grid.filters.filter.Date", config: { fields: { lt: { text: 'Before' }, gt: { text: 'After' }, eq: { text: 'On' } }, dateFormat: null } });
Ext.define("Ext.locale.ru.grid.filters.filter.List", { override: "Ext.grid.filters.filter.List", loadingText: "List" });
Ext.define("Ext.locale.ru.grid.filters.filter.Number", { override: "Ext.grid.filters.filter.Number", emptyText: "Enter number" });
Ext.define("Ext.locale.ru.grid.filters.filter.String", { override: "Ext.grid.filters.filter.String", emptyText: "Enter text" });
Ext.define("Ext.locale.ru.LoadMask", { override: "Ext.LoadMask", msg: "Loading..." });
Ext.define("Ext.locale.ru.grid.RowEditor", { override: "Ext.grid.RowEditor", saveBtnText: 'Ok', cancelBtnText: 'Cancel', errorsText: 'Error', dirtyText: 'Field is required' });
Ext.define("Ext.locale.ru.view.grid.button.Filter", { override: "Ge.view.grid.button.Filter", applyBtnText: 'Apply', resetBtnText: 'Reset' });
Ext.define("Ext.locale.ru.grid.PageSize", { override: "Ge.view.plugin.PageSize", displayText: 'Pages on grid' });
Ext.define("Ext.locale.ru.view.form.Panel", { override: "Ge.view.form.Panel", msgFillFields: 'You need to fill in the fields' });