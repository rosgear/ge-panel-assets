...
Ext.Txt = { message: 'Сообщение', confirmation: 'Подтверждение', warning: 'Предупреждение', error: 'Ошибка', errorConnect: 'Ошибка соединения', loading: 'Загрузка...', waiting: 'Пожалуйста подождите...', sendErrorReport: '<div class="g-message-box__report">Отправить ошибку в техническую поддержку?</div>', serverDidNotAnswer: 'Наш ваш запрос, сервер не дал ответа (ошибка сервера или запрос потерян).', serverErrorConnection: 'Ошибка соединения с сервером может возникнуть из-за нестабильного подключения к сети или отсутствие связи с сервером. Повторите попытку позже.' };
Ext.define("Ext.locale.ru.grid.locking.Lockable", { override: "Ext.grid.locking.Lockable", lockText: "Заблокировать столбец", unlockText: "Разблокировать столбец (разблокировать)" });
Ext.define("Ext.locale.ru.grid.filters.Filters", { override: "Ext.grid.filters.Filters", menuFilterText: "Фильтр" });
Ext.define("Ext.locale.ru.grid.filters.filter.Boolean", { override: "Ext.grid.filters.filter.Boolean", yesText: "Да", noText: "Нет" });
Ext.define("Ext.locale.ru.grid.filters.filter.Date", { override: "Ext.grid.filters.filter.Date", config: { fields: {lt: {text: 'До'}, gt: {text: 'После'}, eq: {text: 'На'}}, dateFormat: null } });
Ext.define("Ext.locale.ru.grid.filters.filter.List", { override: "Ext.grid.filters.filter.List", loadingText: "Список" });
Ext.define("Ext.locale.ru.grid.filters.filter.Number", { override: "Ext.grid.filters.filter.Number", emptyText: "Введите число" });
Ext.define("Ext.locale.ru.grid.filters.filter.String", { override: "Ext.grid.filters.filter.String", emptyText: "Введите текст" });
Ext.define("Ext.locale.ru.LoadMask", { override: "Ext.LoadMask", msg: "Загрузка..." });
Ext.define("Ext.locale.ru.grid.RowEditor", { override: "Ext.grid.RowEditor", saveBtnText: 'Ok', cancelBtnText: 'Отмена', errorsText: 'Ошибка', dirtyText: 'Необходимо заполнить поле' });
Ext.define("Ext.locale.ru.view.grid.button.Filter", { override: "Ge.view.grid.button.Filter", applyBtnText: 'Применить', resetBtnText: 'Сбросить', });
Ext.define("Ext.locale.ru.grid.PageSize", { override: "Ge.view.plugin.PageSize", displayText: 'Записей на странице' });
Ext.define("Ext.locale.ru.view.form.Panel", { override: "Ge.view.form.Panel", msgFillFields: 'Вам необходимо заполнить поля' });